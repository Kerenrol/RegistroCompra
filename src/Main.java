...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Ingrese el nombre del producto (o escriba 'fin' para terminar la lista):");
        ...
        MetodoDePago metodoPago = new MetodoDePago(metodoPagoNombre, montoPagado);
